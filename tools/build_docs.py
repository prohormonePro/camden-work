...
def build(base):
    ...
    pages=['index','quickstart','verification-2026-09-23','architecture','constitution','catalog','tools','maintenance','security','contributing','limits','sources','crosswalks','related-work','licensing']
