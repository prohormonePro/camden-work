...
def build(base):
    ...
    base=base.rstrip('/')+'/'
    from build_differentiation import build as build_overlay
    build_overlay()
    for original,name in [('README.md','overview.md'),('ARCHITECTURE.md','architecture.md'),('CONSTITUTION.md','constitution.md'),('SECURITY.md','security.md'),('CONTRIBUTING.md','contributing.md'),('LICENSING.md','licensing.md')]:
        ...
        (DOCS/name).write_text(text,encoding='utf8',newline='\n')
    ...
    for path in sorted(DOCS.glob('*.md')):
        ...
        rendered='<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>'+html.escape(title)+' | Camden Work</title><link rel="stylesheet" href="style.css"><link rel="alternate" type="text/markdown" href="'+path.name+'"><link rel="describedby" href="llms.txt"></head><body><a class="skip" href="#main">Skip to content</a><header><a class="brand" href="index.html">CAMDEN <span>WORK</span></a><nav aria-label="Main"><a href="quickstart.html">Quickstart</a><a href="catalog.html">Failure catalog</a><a href="evidence.html">Evidence</a></nav></header><main id="main" class="prose"><section>'+body+'</section></main><footer><a href="index.html">Camden Work</a> · Experimental 0.1.0 · <a href="llms.txt">Machine-readable index</a></footer></body></html>'
        (DOCS/(path.stem+'.html')).write_text(rendered,encoding='utf8',newline='\n')
    pages=['positioning','evidence','operator-externalization','continuity-gauntlet','overview','index','quickstart','verification-2026-09-23','architecture','constitution','catalog','tools','maintenance','security','contributing','limits','sources','crosswalks','related-work','licensing']
    footer_nav='<nav aria-label="Documentation">'+''.join('<a href="'+name+'.html">'+label+'</a>' for name,label in [('positioning','Positioning'),('evidence','Evidence'),('operator-externalization','Operator burden'),('continuity-gauntlet','Continuity gauntlet'),('overview','Overview'),('architecture','Architecture'),('constitution','Operating contract'),('tools','Integration'),('maintenance','Recovery and removal'),('sources','Sources'),('crosswalks','Crosswalks'),('related-work','Related work'),('security','Security'),('contributing','Contributing'),('licensing','Licensing')])+'</nav>'
